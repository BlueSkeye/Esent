...
namespace EsentLib.Jet
{
    ...
    {
        /// <summary>Gets or sets the offset to the first byte to be retrieved from a column
        /// of type <see cref="JET_coltyp.LongBinary"/>, or <see cref="JET_coltyp.LongText"/>.</summary>
        public int ibLongValue { get; set; }

        /// <summary>Gets or sets the sequence number of value in a multi-valued column. The
        /// array of values is one-based. The first value is sequence 1, not 0. If the record
        /// column has only one value then 1 should be passed as the itagSequence.</summary>
        public int itagSequence { get; set; }

        /// <summary>Gets the columnid of the retrieved tagged, multi-valued or sparse,
        /// column when all tagged columns are retrieved by passing 0 as the columnid to
        /// JetRetrieveColumn.</summary>
        ...
        /// <see cref="JET_RETINFO"/>.</summary>
        /// <returns>A <see cref="T:System.String"/> that represents the current
        /// <see cref="JET_RETINFO"/>.</returns>
        public override string ToString()
        {
            return string.Format(CultureInfo.InvariantCulture, "JET_RETINFO(ibLongValue={0},itagSequence={1})",
                this.ibLongValue, this.itagSequence);
        }
        ...
        /// <summary>Get a NATIVE_RETINFO structure representing the object.</summary>
        ...
        /// <summary>Sets the fields of the object from a NATIVE_RETINFO structure.</summary>
        ...
        internal void SetFromNativeRetinfo(NATIVE_RETINFO value)
        {
            ...
            this.columnidNextTagged = new JET_COLUMNID { Value = value.columnidNextTagged };
        }
    }
}