...
{
    ///// <summary>The native version of the JET_UNICODEINDEX2 structure.</summary>
    ...
    //{
    //    /// <summary>The locale to be used when normalizing unicode data.</summary>
    ...
    ///// <summary>Customizes how Unicode data gets normalized when an index is created over
    ///// a Unicode column.</summary>
    //public sealed partial class JET_UNICODEINDEX : IContentEquatable<JET_UNICODEINDEX>, IDeepCloneable<JET_UNICODEINDEX>
    //{
    //    /// <summary>Contains a limited mapping of LCIDs to locale names.</summary>
    //    private static readonly Dictionary<int, string> LcidToLocales = new Dictionary<int, string>(10);

    //    /// <summary>Initializes static members of the JET_UNICODEINDEX class.</summary>
    ...
    //    /// <summary>As a workaround for systems that do not have LCID support, we will convert a
    //    /// VERY limited number of LCIDs to locale names.</summary>
    //    /// <returns>A BCP-47 style locale name.</returns>
    //    public string GetEffectiveLocaleName()
    //    {
    //        return this.szLocaleName ?? LimitedLcidToLocaleNameMapping(this.lcid);
    //    }

    //    /// <summary>As a workaround for systems that do not have LCID support, we will convert
    //    /// a VERY limited number of LCIDs to locale names.</summary>
    ...
    //    /// <summary>Gets the native version of this object.</summary>
    ...
    //                "lcid was specified, but this version of the API does not accept LCIDs. Use a locale name or a different API.");
    //        }
    //        ////szLocaleName is converted at pinvoke time.
    //        return new NATIVE_UNICODEINDEX2 { dwMapFlags = this.dwMapFlags };
    //    }
    //}
}