...
namespace EsentLib.Jet
{
    ...
    {
        /// <summary>The time in seconds. This value can be 0 to 59.</summary>
        private readonly byte bSeconds;

        /// <summary>The time in minutes. This value can be 0 to 59.</summary>
        private readonly byte bMinutes;

        /// <summary>The time in hours. This value can be 0 to 23.</summary>
        private readonly byte bHours;

        /// <summary>The day of the month. This value can be 0 to 31. 0 is used when the structure
        /// is null.</summary>
        private readonly byte bDays;

        /// <summary>The month. This value can be 0 to 12. 0 is used when the structure is
        /// null.</summary>
        private readonly byte bMonth;

        /// <summary>The year of the event, offset by 1900.</summary>
        private readonly byte bYear;

        /// <summary>IsUTC flag at the first bit. Starting from win8, milliseconds (low part)
        /// is filled at left 7 bits.</summary>
        private readonly byte bFiller1;

        /// <summary>OSSnapshot flag at the first bit, Starting from win8, milliseconds (high part)
        /// is filled at following 3 bits. Other bits are reserved.</summary>
        private readonly byte bFiller2;

        /// <summary>Initializes a new instance of the <see cref="JET_BKLOGTIME"/> struct.</summary>
        /// <param name="time">The DateTime to intialize the structure with.</param>
        /// <param name="isSnapshot">True if this time is for a snapshot backup.</param>
        ...
        /// <summary>Gets a value indicating whether the JET_BKLOGTIME has a null value.</summary>
        public bool HasValue
        {
            get { return 0 != this.bMonth && 0 != this.bDays; }
        }

        /// <summary>Gets a value indicating whether the JET_BKLOGTIME is in UTC.</summary>
        [SuppressMessage(
            "Microsoft.StyleCop.CSharp.NamingRules",
        ...
        /// <summary>Gets a value indicating whether the JET_BKLOGTIME is for a snapshot backup.
        /// </summary>
        [SuppressMessage(
            "Microsoft.StyleCop.CSharp.NamingRules",
            "SA1300:ElementMustBeginWithUpperCaseLetter",
        ...
        /// <summary>Determines whether two specified instances of JET_BKLOGTIME are equal.</summary>
        ...
        /// <summary>Determines whether two specified instances of JET_BKLOGTIME are not equal.
        /// </summary>
        /// <param name="lhs">The first instance to compare.</param>
        /// <param name="rhs">The second instance to compare.</param>
        ...
        /// <summary>Generate a DateTime representation of this JET_BKLOGTIME.</summary>
        /// <returns>A DateTime representing the JET_BKLOGTIME. If the JET_BKLOGTIME is null
        /// then null is returned.</returns>
        public DateTime? ToDateTime()
        {
            if (!this.HasValue) { return null; }
            return new DateTime(this.bYear + 1900, this.bMonth, this.bDays, this.bHours, this.bMinutes,
                this.bSeconds, checked((int)((((uint)this.bFiller2 & 0xE) << 6) | (((uint)this.bFiller1 & 0xFE) >> 1))),
        ...
        public override string ToString()
        {
            return string.Format(CultureInfo.InvariantCulture,
                ...
                this.bSeconds, this.bMinutes, this.bHours, this.bDays, this.bMonth, this.bYear,
                this.bFiller1, this.bFiller2);
        }
        ...
        public override int GetHashCode()
        {
            ...
            return this.bSeconds.GetHashCode() ^ (this.bMinutes << 6) ^ (this.bHours << 12)
                   ^ (this.bDays << 17) ^ (this.bMonth << 22) ^ (this.bYear << 24) ^ this.bFiller1
                   ^ (this.bFiller2 << 8);
        }

        /// <summary>Returns a value indicating whether this instance is equal to another instance.
        /// </summary>
