...
namespace EsentLib.Jet
{
    ...
    internal struct NATIVE_COLUMNBASE_WIDE
    {
        ...
        /// <summary>The table from which the current table inherits its DDL.</summary>
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = NameSize)]
        public string szBaseTableName;

        /// <summary>The name of the column in the template table.</summary>
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = NameSize)]
        public string szBaseColumnName;

        /// <summary>Max size of the table/column name string.</summary>
        private const int NameSize = 256;
    }
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="JET_COLUMNBASE"/> class.</summary>
        ...
        /// <summary>Gets type of the column.</summary>
        public JET_coltyp coltyp { get; internal set; }

        /// <summary>Gets code page of the column. This is only meaningful for columns of type
        /// <see cref="JET_coltyp.Text"/> and <see cref="JET_coltyp.LongText"/>.</summary>
        public JET_CP cp { get; internal set; }

        /// <summary>Gets the maximum length of the column. This is only meaningful for columns
        /// of type <see cref="JET_coltyp.Text"/>, <see cref="JET_coltyp.LongText"/>,
        /// <see cref="JET_coltyp.Binary"/> and <see cref="JET_coltyp.LongBinary"/>.</summary>
        public int cbMax { get; internal set; }

        /// <summary>Gets the column options.</summary>
        ...
        /// <summary>Gets the table from which the current table inherits its DDL.</summary>
        public string szBaseTableName { get; internal set; }

        /// <summary>Gets the name of the column in the template table.</summary>
        public string szBaseColumnName { get; internal set; }

        /// <summary>Returns a <see cref="T:System.String"/> that represents the current
        /// <see cref="JET_COLUMNBASE"/>.</summary>
        /// <returns>A <see cref="T:System.String"/> that represents the current
        /// <see cref="JET_COLUMNBASE"/>.</returns>
        ...
        {
            return ((null != obj) && (GetType() == obj.GetType())
                && this.Equals((JET_COLUMNBASE)obj));
        }
