...
namespace EsentLib.Jet
{
    ...
    {
        /// <summary>The size of a NATIVE_RSTINFO structure.</summary>
        public static readonly int SizeOfRstinfo = Marshal.SizeOf(typeof(NATIVE_RSTINFO));

        /// <summary>Size of the structure.</summary>
        public uint cbStruct;

        /// <summary>The array of <see cref="NATIVE_RSTMAP"/> structures.</summary>
        public unsafe NATIVE_RSTMAP* rgrstmap;

        /// <summary>The number of elements in the restore-map array.</summary>
        public uint crstmap;

        /// <summary>The log position at which it stopped.</summary>
        public JET_LGPOS lgposStop;

        /// <summary>The time at which it stopped.</summary>
        public JET_LOGTIME logtimeStop;

        /// <summary>The callback to the status function.</summary>
        public NATIVE_PFNSTATUS pfnStatus;
    }

    /// <summary>Contains optional input and output parameters for JetRetrieveColumn.</summary>
    [SuppressMessage(
        "Microsoft.StyleCop.CSharp.NamingRules",
    ...
    {
        /// <summary>Gets or sets the array of <see cref="JET_RSTMAP"/> structures.</summary>
        public JET_RSTMAP[] rgrstmap { get; set; }

        /// <summary>Gets or sets the number of elements in the restore-map array.</summary>
        public int crstmap { get; set; }

        /// <summary>Gets or sets the log position to stop recovery at.</summary>
        public JET_LGPOS lgposStop { get; set; }

        /// <summary>Gets or sets the time at which it stopped.</summary>
        public JET_LOGTIME logtimeStop { get; set; }

        /// <summary>Gets or sets the callback to Gets or sets the status function.</summary>
        public JET_PFNSTATUS pfnStatus { get; set; }

        /// <summary>Check this object to make sure its parameters are valid.</summary>
        internal void CheckMembersAreValid()
        {
            if (0 > this.crstmap) {
                throw new ArgumentOutOfRangeException("crstmap", this.crstmap,
                    "cannot be negative");                
            }

            if ((null == this.rgrstmap) && (0 < this.crstmap)) {
                throw new ArgumentOutOfRangeException("crstmap", this.crstmap,
                    "must be zero");
            }
        ...
        /// <summary>Get a native version of this managed structure.</summary>
        ...
        /// <see cref="JET_RSTINFO"/>.</summary>
        /// <returns>A <see cref="T:System.String"/> that represents the current
        /// <see cref="JET_RSTINFO"/>.</returns>
        public override string ToString()
        {
            return string.Format(CultureInfo.InvariantCulture, "JET_RSTINFO(crstmap={0})",
                this.crstmap);
        }
    }
}