...
namespace EsentLib.Jet
{
    ...
    internal unsafe struct NATIVE_OPENTEMPORARYTABLE
    {
        ...
        /// <summary>Columns to create.</summary>
        public NATIVE_COLUMNDEF* prgcolumndef;

        /// <summary>Number of entries in prgcolumndef.</summary>
        public uint ccolumn;

        /// <summary>Optional pointer to unicode index information.</summary>
        public NATIVE_UNICODEINDEX* pidxunicode;

        /// <summary>Table options.</summary>
        public uint grbit;

        /// <summary>Pointer to array of returned columnids. This should have at least ccolumn
        /// entries.</summary>
        public uint* rgcolumnid;

        /// <summary>Maximum key size.</summary>
        public uint cbKeyMost;

        /// <summary>Maximum amount of data used to construct a key.</summary>
        public uint cbVarSegMac;

        /// <summary>Returns the tableid of the new table.</summary>
    ...
    public partial class JET_OPENTEMPORARYTABLE
    {
        ...
        /// <see cref="JET_param.KeyMost"/> for more information.
        /// </summary>
        ...
        ///// <summary>Returns the unmanaged opentemporarytable that represents this managed class.</summary>
        ///// <returns>A native (interop) version of the JET_OPENTEMPORARYTABLE.</returns>
