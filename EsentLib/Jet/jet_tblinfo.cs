...
namespace EsentLib.Jet
{
    ...
    public enum JET_TblInfo
    {
        ...
        /// <see cref="LegacyApi.JetGetTableInfo(JET_SESID,JET_TABLEID,out JET_OBJECTINFO,JET_TblInfo)"/>.
        /// </summary>
        Default = 0,

        /// <summary>
        /// Retrieves the name of the table. Use this option with
        /// <see cref="LegacyApi.JetGetTableInfo(JET_SESID,JET_TABLEID,out string,JET_TblInfo)"/>.
        /// </summary>
        Name = 1,
        ...
        /// <see cref="LegacyApi.JetGetTableInfo(JET_SESID,JET_TABLEID,out JET_DBID,JET_TblInfo)"/>.
        /// </summary>
        Dbid = 2,
        ...
        /// <see cref="LegacyApi.JetGetTableInfo(JET_SESID,JET_TABLEID,int[],JET_TblInfo)"/>.
        /// </summary>
        SpaceUsage = 7,
        ...
        /// <see cref="LegacyApi.JetGetTableInfo(JET_SESID,JET_TABLEID,out int,JET_TblInfo)"/>.
        /// </summary>
        SpaceOwned = 10,
