...
namespace EsentLib.Jet
{
    ...
    internal struct NATIVE_COLUMNLIST
    {
        ...
        public uint cRecord;
        /// <summary>Columnid of the presentation order column.</summary>
        public uint columnidPresentationOrder;
        /// <summary>Columnid of the name column.</summary>
        public uint columnidcolumnname;
        /// <summary>Columnid of the columnid column.</summary>
        public uint columnidcolumnid;
        /// <summary>Columnid of the coltyp column.</summary>
        public uint columnidcoltyp;
        /// <summary>Columnid of the country column.</summary>
        public uint columnidCountry;
        /// <summary>Columnid of the langid column.</summary>
        public uint columnidLangid;
        /// <summary>Columnid of the codepage column.</summary>
        public uint columnidCp;
        /// <summary>Columnid of the collation column.</summary>
        public uint columnidCollate;
        /// <summary>Columnid of the cbMax column.</summary>
        public uint columnidcbMax;
        /// <summary>Columnid of the grbit column.</summary>
        public uint columnidgrbit;
        /// <summary>Columnid of the default value column.</summary>
        public uint columnidDefault;
        /// <summary>Columnid of the base table name column.</summary>
        public uint columnidBaseTableName;
        /// <summary>Columnid of the base column name column.</summary>
        public uint columnidBaseColumnName;
        /// <summary>The column identifier of the name of the column definition.</summary>
        public uint columnidDefinitionName;
    }

    /// <summary>Information about a temporary table containing information about all columns
    /// for a given table.</summary>
    [SuppressMessage(
        "Microsoft.StyleCop.CSharp.NamingRules",
    ...
    {
        /// <summary>Gets tableid of the temporary table. This should be closed when the table
        ...
        /// <summary>Gets the columnid of the column in the temporary table which stores the default
        /// value of the column.</summary>
        public JET_COLUMNID columnidDefault { get; internal set; }

        /// <summary>Gets the columnid of the column in the temporary table which tores the name of
        /// the base table.</summary>
        ...
        /// <see cref="JET_COLUMNLIST"/>.</summary>
        /// <returns>A <see cref="T:System.String"/> that represents the current
        /// <see cref="JET_COLUMNLIST"/>.</returns>
        public override string ToString()
        {
            return string.Format(CultureInfo.InvariantCulture, "JET_COLUMNLIST(0x{0:x},{1} records)",
