...
{
    /// <summary>The native version of the JET_ERRINFOBASIC structure.</summary>
    ...
    {
        /// <summary>The number of elements in the error hierarchy.</summary>
        public const int HierarchySize = 8;

        /// <summary>The length of the source file where the error occurred.</summary>
        public const int SourceFileLength = 64;

        /// <summary>Size of the structure.</summary>
        public uint cbStruct;

        /// <summary>The error value for the requested info level.</summary>
        public JET_err errValue;

        /// <summary>The most specific category of the error.</summary>
        public JET_ERRCAT errcatMostSpecific;

        /// <summary>Hierarchy of error categories. Position 0 is the highest level in the
        /// hierarchy, and the rest are JET_errcatUnknown.</summary>
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = HierarchySize)]
        public byte[] rgCategoricalHierarchy;

        /// <summary>The source file line for the requested info level.</summary>
        public uint lSourceLine;

        /// <summary>The source file name for the requested info level.</summary>
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = SourceFileLength)]
        public string rgszSourceFile;
    }

    /// <summary>Contains the information about an error.</summary>
    [SuppressMessage(
        "Microsoft.StyleCop.CSharp.NamingRules",
    ...
    public sealed class JET_ERRINFOBASIC : IContentEquatable<JET_ERRINFOBASIC>, IDeepCloneable<JET_ERRINFOBASIC>
    {
        ...
        /// <summary>Initializes a new instance of the JET_ERRINFOBASIC class.</summary>
        public JET_ERRINFOBASIC()
        {
            this.rgCategoricalHierarchy = new JET_ERRCAT[NATIVE_ERRINFOBASIC.HierarchySize];
        }

        /// <summary>Gets or sets the error value for the requested info level.</summary>
        public JET_err errValue
        {
            [DebuggerStepThrough]
        ...
        /// <summary>Gets or sets the category of the error.</summary>
        ...
        /// <summary>Gets or sets the hierarchy of errors. Position 0 is the highest level in
        /// the hierarchy, and the rest are JET_errcatUnknown.</summary>
        ...
        /// <summary>Gets or sets the source file line for the requested info level.</summary>
        ...
        /// <summary>Gets or sets the source file name for the requested info level.</summary>
        public string rgszSourceFile
        {
            [DebuggerStepThrough]
        ...
        {
            return (JET_ERRINFOBASIC)this.MemberwiseClone();
        }
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "JET_ERRINFOBASIC({0}:{1}:{2}:{3})",
                this.errValue, this.errcat, this.rgszSourceFile, this.lSourceLine);
        }
        ...
        /// <summary>Sets the fields of the object from a native JET_ERRINFOBASIC struct.</summary>
        /// <param name="value">The native errinfobasic to set the values from.</param>
