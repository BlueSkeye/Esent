...
namespace EsentLib
{
    /// <summary>This is the base class for all esent resource objects. Subclasses of this class
    /// can allocate and release unmanaged resources.</summary>
    public abstract class EsentResource : IDisposable
    {
        /// <summary>Finalizes an instance of the EsentResource class.</summary>
        ~EsentResource()
        {
            this.Dispose(false);
        }

        /// <summary>Gets a value indicating whether the underlying resource is currently
        /// allocated.</summary>
        protected bool HasResource
        {
            get { return this.hasResource; }
        }
        ...
        /// <summary>Throw an exception if this object has been disposed.</summary>
        ...
        /// <summary>Called by a subclass when a resource is allocated.</summary>
        ...
        /// <summary>Called by a subclass when a resource is freed.</summary>
        ...
        /// <summary>Implemented by the subclass to release a resource.</summary>
        protected abstract void ReleaseResource();

        /// <summary>True if a resource has been allocated.</summary>
