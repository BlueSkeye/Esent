...
namespace EsentLib
{
    ...
    public class IndexSegment : IEquatable<IndexSegment>
    {
        ...
        /// <summary>True if the column is sorted in ascending order.</summary>
        private readonly bool isAscending;

        /// <summary>True if the column is an ASCII column.</summary>
        private readonly bool isASCII;

        /// <summary>Initializes a new instance of the IndexSegment class.</summary>
        ...
        /// <summary>Gets name of the column being indexed.</summary>
        ...
        /// <summary>Gets the type of the column being indexed.</summary>
        ...
        /// <summary>Gets a value indicating whether the index segment is ascending.</summary>
        ...
        /// <summary>Gets a value indicating whether the index segment is over an ASCII text
        /// column. This value is only meaningful for text column segments.</summary>
        public bool IsASCII
        {
            [DebuggerStepThrough]
        ...
        {
            return ((null != obj) && (this.GetType() == obj.GetType()) && this.Equals((IndexSegment)obj));
        }
        ...
        public override string ToString()
        {
            return string.Format(CultureInfo.InvariantCulture, "{0}{1}({2})",
                this.isAscending ? "+" : "-", this.columnName, this.coltyp);
        }
        ...
        {
            return (null != other)
                && this.columnName.Equals(other.columnName, StringComparison.OrdinalIgnoreCase)
