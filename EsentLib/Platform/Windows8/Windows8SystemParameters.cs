...
namespace EsentLib
{
    /// <summary>This class provides static properties to set and get global ESENT system parameters.
    /// </summary>
    public partial class SystemParameters
    {
        ...
        {
            get { return GetIntegerParameter(Windows8Param.MinDataForXpress); }
            set { JetEnvironment.SetParameter(Windows8Param.MinDataForXpress, value); }
        }
        ...
        {
            get { return GetIntegerParameter(Windows8Param.HungIOThreshold); }
            set { JetEnvironment.SetParameter(Windows8Param.HungIOThreshold, value); }
        }

        /// <summary>Gets or sets the set of actions to be taken on IOs that appear hung.</summary>
        public static int HungIOActions
        {
            get { return GetIntegerParameter(Windows8Param.HungIOActions); }
            set { JetEnvironment.SetParameter(Windows8Param.HungIOActions, value); }
        }

        /// <summary>Gets or sets the friendly name for this instance of the process.</summary>
        public static string ProcessFriendlyName
        {
            get { return GetStringParameter(Windows8Param.ProcessFriendlyName); }
            set { JetEnvironment.SetParameter(Windows8Param.ProcessFriendlyName, value); }
        }
    }
}
