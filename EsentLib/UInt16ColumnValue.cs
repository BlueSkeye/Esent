...
namespace EsentLib
{
    /// <summary>A <see cref="ushort"/> column value.</summary>
    [CLSCompliant(false)]
    public class UInt16ColumnValue : ColumnValueOfStruct<ushort>
    {
        ...
        /// <param name="tableid">The table to set the columns in. An update should be
        /// prepared.</param>
        ...
        {
            if (JET_wrn.ColumnNull == (JET_wrn)err) { this.Value = null; }
            else {
