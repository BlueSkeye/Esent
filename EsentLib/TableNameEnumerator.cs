...
namespace EsentLib
{
    /// <summary>Enumerate the names of tables in a database.</summary>
    internal sealed class TableNameEnumerator : TableEnumerator<string>
    {
        /// <summary>The database containing the tables.</summary>
        private readonly JET_DBID dbid;

        /// <summary>Object list containing information about tables.</summary>
        private JET_OBJECTLIST objectlist;

        /// <summary>Initializes a new instance of the <see cref="TableNameEnumerator"/> class.</summary>
        /// <param name="sesid">The session to use.</param>
        /// <param name="dbid">The database to get the table names from.</param>
        ...
        protected override string GetCurrent()
        {
            ...
            string name = Api.RetrieveColumnAsString(this.Sesid, this.TableidToEnumerate,
                this.objectlist.columnidobjectname, encodingOfTextColumns, RetrieveColumnGrbit.None);
            return StringCache.TryToIntern(name);
        }

        /// <summary>Open the table to be enumerated. This should set <see cref="TableEnumerator{T}.TableidToEnumerate"/>.</summary>
