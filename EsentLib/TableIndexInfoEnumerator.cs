...
namespace EsentLib
{
    /// <summary>Enumerate columns in a table specified by dbid and name.</summary>
    internal sealed class TableIndexInfoEnumerator : IndexInfoEnumerator
    {
        /// <summary>The database containing the table.</summary>
        private readonly JET_DBID dbid;

        /// <summary>The name of the table.</summary>
        private readonly string tablename;

        /// <summary>Initializes a new instance of the <see cref="TableIndexInfoEnumerator"/>
        /// class.</summary>
        ...
        protected override void GetIndexInfo(JET_SESID sesid, string indexname, out string result,
