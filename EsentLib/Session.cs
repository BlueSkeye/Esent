...
namespace EsentLib
{
    ///// <summary>A class that encapsulates a JET_SESID in a disposable object.</summary>
    //public class Session : EsentResource
    //{
    //    ///// <summary>The underlying JET_SESID.</summary>
    //    //private JET_SESID sesid;

    //    ///// <summary>Initializes a new instance of the Session class. A new JET_SESSION is
    //    ///// allocated from the given instance.</summary>
    ...
    //    ///// <summary>Gets the JET_SESID that this session contains.</summary>
    ...
    //    ///// <summary>Implicit conversion operator from a Session to a JET_SESID. This allows
    //    ///// a Session to be used with APIs which expect a JET_SESID.</summary>
    ...
    //    ///// <summary>Free the underlying JET_SESID.</summary>
