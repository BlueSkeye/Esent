...
namespace EsentLib
{
    /// <summary>Class that helps cache strings.</summary>
    internal static class StringCache
    {
        /// <summary>Return the interned version of a string, or the original string if it
        /// isn't interned.</summary>
        ...
        /// <summary>Convert a char array to a string, using a cached value if possible.</summary>
        ...
        private static unsafe string GetString(char* value, int startIndex, int count)
        {
            ...
            else { s = CreateNewString(value, startIndex, count); }
            return s;
        }

        /// <summary>Calculate the hash of a string.</summary>
        ...
        /// <summary>Determine if a string matches a char array..</summary>
        ...
        private static unsafe bool AreEqual(string s, char* value, int startIndex, int count)
        {
            ...
            unchecked {
                for (int i = 0; i < s.Length; ++i) {
                    if (s[i] != value[startIndex + i]) { return false; }
                }
            }
            return true;
        }

        /// <summary>Convert a char array to a string.</summary>
        /// <param name="value">The characters to convert.</param>
        /// <param name="startIndex">The starting index of the data to convert.</param>
        /// <param name="count">The number of characters to convert.</param>
        /// <returns>A string converted from the data.</returns>
        ...
        /// <summary>Don't cache strings whose length is longer than this.</summary>
        private const int MaxLengthToCache = 128;
        /// <summary>Number of converted strings to hash.</summary>
        private const int NumCachedBoxedValues = 1031;
        /// <summary>Cached string values.</summary>
