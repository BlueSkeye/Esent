...
{
    ///// <summary>A class which wraps the callback dealing with durable commits.</summary>
    ...
    //{
        ...
        ///// <summary>Instance associated with this callback.</summary>
        //private JET_INSTANCE instance;

        ///// <summary>Hold a reference to the delegate so that it doesn't get garbage-collected.</summary>
        ...
        ///// <summary>Initializes a new instance of the <see cref="DurableCommitCallback"/> class. 
        ///// The constructor.</summary>
        ///// <param name="instance">The instance with which to associate the callback.</param>
        ///// <param name="wrappedCallback">The managed code callback to call.</param>
