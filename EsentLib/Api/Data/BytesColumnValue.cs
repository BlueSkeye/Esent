...
namespace EsentLib.Api.Data
{
    ...
    public class BytesColumnValue : ColumnValue
    {
        ...
        /// <see cref="BytesColumnValue"/>.</summary>
        /// <returns>A <see cref="T:System.String"/> that represents the current
        /// <see cref="BytesColumnValue"/>.</returns>
        public override string ToString()
        {
            return (null == this.Value)
                ? string.Empty
                : BitConverter.ToString(this.Value, 0, Math.Min(this.Value.Length, 16));
        }
