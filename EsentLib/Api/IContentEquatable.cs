...
{
    /// <summary>Interface for objects that can have their contents compared against each other.
    /// This should be used for equality comparisons on mutable reference objects where overriding
    /// Equals() and GetHashCode() isn't a good idea.</summary>
