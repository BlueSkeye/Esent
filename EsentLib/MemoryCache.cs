...
namespace EsentLib
{
    /// <summary>Cache allocated chunks of memory that are needed for very short periods
    /// of time. The memory is not zeroed on allocation.</summary>
    internal sealed class MemoryCache
    {
        /// <summary>Initializes a new instance of the <see cref="MemoryCache"/> class.</summary>
        /// <param name="bufferSize">The size of the buffers to cache.</param>
        ...
        /// <summary>Gets the size of the buffers that this cache returns.</summary>
        public int BufferSize
        {
            get { return this.bufferSize; }
        }

        /// <summary>Gets the cached buffers for columns.</summary>
        ...
        /// <summary>Gets the cached buffers for keys and bookmarks.</summary>
        ...
        /// <summary>Gets the cached buffers for keys and secondary bookmarks.</summary>
        ...
        /// <summary>Allocates a chunk of memory. If memory is cached it is returned. If no
        /// memory is cached then it is allocated. Check the size of the returned buffer to
        /// determine how much memory was allocated.</summary>
        ...
        /// <summary>Frees an unused buffer. This may be added to the cache.</summary>
        ...
        public void Free(ref byte[] data)
        {
            ...
            if (data.Length != this.bufferSize) {
                throw new ArgumentOutOfRangeException("data", data.Length,
                    "buffer is not correct size for this MemoryCache");    
            }
            int offset = this.GetStartingOffset();
        ...
        /// <summary>Get the offset in the cached buffers array to start allocating or freeing 
        /// buffers to. This is done so that all threads don't start operating on slot zero,
        /// which would increase contention.</summary>
        ...
        /// <summary>The maximum key size that any version of ESENT can have for any page size.
        /// This is also the maximum bookmark size.</summary>
        private const int KeyMostMost = 2000;
        /// <summary>The maximum number of buffers we want in a cache.</summary>
        private const int MaxBuffers = 16;
        /// <summary>Cached buffers for keys and bookmarks.</summary>
        private static readonly MemoryCache TheBookmarkCache = new MemoryCache(KeyMostMost, MaxBuffers);
        /// <summary>Cached buffers for columns.</summary>
        ...
        /// <summary>A zero-length array that should be used whenever we want to return one.</summary>
        private static readonly byte[] ZeroLengthArray = new byte[0];
        /// <summary>Default size for newly allocated buffers.</summary>
        private readonly int bufferSize;
        /// <summary>Currently cached buffers.</summary>
