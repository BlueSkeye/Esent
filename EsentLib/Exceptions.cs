...
namespace EsentLib
{
    ...
    /// <summary>Base class for JET_err.FileIORetry exceptions.</summary>
    [SuppressMessage("Microsoft.StyleCop.CSharp.MaintainabilityRules",
        "SA1402:FileMayOnlyContainASingleClass", Justification = "Auto-generated code.")]
    [Serializable]
    public sealed class EsentFileIORetryException : EsentObsoleteException
    {
        /// <summary>Initializes a new instance of the EsentFileIORetryException class.
        /// </summary>
    ...
    internal static class EsentExceptionHelper
    {
        ...
        {
            if (err < 0) { throw JetErrToException(unchecked((JET_err)err)); }
            return unchecked((JET_wrn)err);
        }

        /// <summary>Create an EsentErrorException from an error code.</summary>
