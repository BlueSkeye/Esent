...
namespace EsentLib
{
    /// <summary>Information about one Esent column. This is not an interop class, but is used
    /// by the meta-data helper methods.</summary>
    public sealed class ColumnInfo
    {
        /// <summary>Initializes a new instance of the ColumnInfo class.</summary>
        ...
        internal ColumnInfo(string name, JET_COLUMNID columnid, JET_coltyp coltyp, JET_CP cp,
            int maxLength, byte[] defaultValue, ColumndefGrbit grbit)
        {
            this.Name = name;
        ...
        /// <summary>Gets the ID of the column.</summary>
        ...
        /// <see cref="ColumnInfo"/>.</summary>
        /// <returns>A <see cref="T:System.String"/> that represents the current
        /// <see cref="ColumnInfo"/>.</returns>
