...
namespace EsentLib
{
    /// <summary>Helper methods for the ESENT API. These methods deal with database
    /// meta-data.</summary>
    public static partial class Api
    {
        ...
        public static JET_wrn OpenTable(JET_SESID sesid, JET_DBID dbid, string tablename,
            OpenTableGrbit grbit, out JET_TABLEID tableid)
        {
        ...
        /// <summary>Try to open a table.</summary>
        /// <param name="sesid">The session to use.</param>
        ...
        public static bool TryOpenTable(JET_SESID sesid, JET_DBID dbid, string tablename,
            OpenTableGrbit grbit, out JET_TABLEID tableid)
        {
        ...
        /// <summary>Creates a dictionary which maps column names to their column IDs.</summary>
            ...
            try {
                ...
                if (columnlist.cRecord > 0) {
                    if (Api.TryMoveFirst(sesid, columnlist.tableid)) {
                        do {
                            string name = RetrieveColumnAsString(sesid, columnlist.tableid,
                                columnlist.columnidcolumnname, encodingOfTextColumns,
        ...
        /// <summary> Get the columnid of the specified column.</summary>
        /// <param name="sesid">The session to use.</param>
        ...
        /// <summary>Iterates over all the columns in the table, returning information
        /// about each one.</summary>
        /// <param name="sesid">The session to use.</param>
        ...
        /// <summary>Iterates over all the indexes in the table, returning information
        /// about each one.</summary>
        /// <param name="sesid">The session to use.</param>
        ...
        /// <summary>Iterates over all the indexs in the table, returning information
        /// about each one.</summary>
        /// <param name="sesid">The session to use.</param>
        /// <param name="dbid">The database containing the table.</param>
        /// <param name="tablename">The name of the table.</param>
        ...
        /// <summary>Returns the names of the tables in the database.</summary>
        /// <param name="sesid">The session to use.</param>
        /// <param name="dbid">The database containing the table.</param>
        ...
        public static bool TryJetGetTableIndexInfo(JET_SESID sesid, JET_TABLEID tableid,
        ...
        /// <summary>Determines the name of the current index of a given cursor.</summary>
        /// <remarks> This name is also used to later re-select that index as the 
        /// index using <see cref="JetSetCurrentIndex"/>. It can also be used to discover
        /// the properties of that index using JetGetTableIndexInfo.
        /// The returned name of the index will be null if the current index is the clustered
        /// index and no primary index was explicitly defined.</remarks>
        /// <param name="sesid">The session to use.</param>
