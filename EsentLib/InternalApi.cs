...
namespace EsentLib
{
    ...
    public static partial class InternalApi
    {
        ...
        /// <remarks>This is an internal method that takes a buffer offset as well as size.
        /// </remarks>
        ...
        public static JET_wrn JetRetrieveColumn(JET_SESID sesid, JET_TABLEID tableid,
            JET_COLUMNID columnid, byte[] data, int dataSize, int dataOffset,
        ...
        {
            return EsentExceptionHelper.Check(EsentLib.LegacyApi.Impl.JetRetrieveColumn(sesid, tableid, columnid,
