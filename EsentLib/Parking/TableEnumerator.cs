...
namespace EsentLib
{
    ///// <summary>Base class for enumerators that walk a table.</summary>
    ///// <typeparam name="T">The type returned by the enumerator.</typeparam>
    //internal abstract class TableEnumerator<T> : IEnumerator<T>
    //{
    //    /// <summary>Initializes a new instance of the <see cref="TableEnumerator{T}"/> class.</summary>
    ...
    //    /// <summary>Gets the session used for the enumeration.</summary>
    //    protected JET_SESID Sesid { get; private set; }

    //    /// <summary>Gets or sets the table being enumerated.</summary>
    //    protected JET_TABLEID TableidToEnumerate { get; set; }

    //    ///// <summary>Closes the table being enumerated.</summary>
    ...
    //    ///// <summary>Disposes of any resources the enumerator is using.</summary>
    //    //public void Dispose()
    //    //{
    //    //    this.CloseTable();
    ...
    //    /// <summary>Gets the entry the cursor is currently positioned on.</summary>
    ...
    //    /// <summary>Open the table to be enumerated. This should set <see cref="TableidToEnumerate"/>.</summary>
    //    protected abstract void OpenTable();

    //    /// <summary>Resets the enumerator. The next call to MoveNext will move to the first
    //    /// entry.</summary>
    //    public void Reset()
    //    {
    //        this.isAtEnd = false;
    ...
    //    /// skipped (not returned). By default this is false.</summary>
    ...
    //    /// <summary>True if we are at the end of the table.</summary>
    //    private bool isAtEnd;
    //    /// <summary>True if we need to move to the first record in the table.</summary>
